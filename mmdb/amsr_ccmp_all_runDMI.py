...
dir_mmdb_out='/group_workspaces/cems2/esacci_sst/mms_new/mmd/mmd06c_re01_pp/wind/' #'f:/data/mmd/mmd06c_wnd/';
dir_ccmp='/group_workspaces/cems2/esacci_sst/scratch/jhoeyer001/CCMP_winds/ccmp/v02.0/Y' #'F:/data/sat_data/ccmp/v02.0/Y'
#dir_mmdb='f:/data/mmd/new_mmd/';
#dir_mmdb_out='f:/data/mmd/mmd06c_wnd/';
