...
! [MW 2012] Table 2
character(len=200), parameter     :: file_coeffs_wind_isotropic = 'C:\RSS_RTM\external_files\finetune_emiss_wind.dat' 

! [MW 2012] Tables 3 + 4
character(len=200), parameter     :: file_coeffs_wind_direction = 'C:\RSS_RTM\external_files\fit_emiss_phir_wind.dat' 

! [MW 2012] Tables 8, 9, 10, 11, 12
character(len=200), parameter     :: file_coeffs_sctterm        = 'C:\RSS_RTM\external_files\mk_scatterm_table_all.dat' 

! [MW 2012] eq. (15) for fast computation
character(len=200), parameter     :: file_em0_ref_freq_sst      = 'C:\RSS_RTM\external_files\em0_ref_freq_sst.dat' 
